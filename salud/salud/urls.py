...
from salud.custom_routers import HybridRouter
...
router.add_api_view("GetMedicosEnTurnos", url(r'GetMedicosEnTurnos', GetMedicosEnTurnos.as_view(), name="GetMedicosEnTurnos"))
router.add_api_view("ObetenerMedicosPorEspecialidad", url(r'ObetenerMedicosPorEspecialidad', GetMedicosPorEspecialidad.as_view(), name="ObetenerMedicosPorEspecialidad"))
