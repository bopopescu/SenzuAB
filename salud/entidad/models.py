...
class Entidad(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.nombre:
            ...
            raise ValueError("Se debe ingresar un nombre para la Entidad.")
        if self.nombre_legal:
            self.nombre_legal = self.nombre_legal.capitalize()
        else:
            raise ValueError("Se debe ingresar un nombre legal para la Entidad")
...
class Sala(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.nombre:
            ...
            raise ValueError("Se debe ingresar un nombre para la Sala.")
...
class Pasillo(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.nombre:
            ...
            raise ValueError("Se debe ingresar un nombre para el Pasillo.")
